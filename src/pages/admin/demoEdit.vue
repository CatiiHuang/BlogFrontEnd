...
export default {
  ...
  mounted: function() {
    if (this.$route.params.id) {
      this.$axios
        .get(webUrl + "demoDetail/" + this.$route.params.id)
        .then(res => {
  ...
  methods: {
    ...
    saveArticle: function() {
      ...
      if (this.$route.params.id) {
        ...
        this.$axios
          .post(webUrl + "admin/updateDemo", { demoInformation: obj })
          .then(response => {
            self.$message({
              message: "更新文章成功",
              type: "success"
        ...
        this.$axios
          .post(webUrl + "admin/saveDemo", { demoInformation: obj })
          .then(res => {
