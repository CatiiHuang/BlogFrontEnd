...
const routes = [
  {
    path:'/admin',
    name:'admin',
    component: r => require.ensure([], () => r(require('@/pages/admin/admin')), 'chunkname1'),
    children: [
      // {
      //   path: '/admin/list',
      //   name: 'ArticleList',
      ...
      // },
      {
        ...
        name:"musicList",
        component: r => require.ensure([], () => r(require('@/pages/admin/musicList')), 'chunkname2'),
      },
      {
        path:"/admin/artList",
        name:"artList",
        component: r => require.ensure([], () => r(require('@/pages/admin/artList')), 'chunkname2'),
      },
      {
        path:"/admin/demoList",
        name:"demoList",
        component: r => require.ensure([], () => r(require('@/pages/admin/demoList')), 'chunkname2'),
      },
      {
        path: '/admin/edit',
        name: 'ArticleEdit',
