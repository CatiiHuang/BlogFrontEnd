<template>
  <header>
    <div class="wrapper">
      <el-row>
        <el-col :xs="20" :sm="4" :md="4" :lg="4" :xl="4"><div class="logo">Mr Div,</div></el-col>
...
<!--            <el-menu-item index="4"><router-link to="/collections"><i class="iconfont icon-shoucang"></i>Collections</router-link></el-menu-item>-->
            ...
            <el-menu-item index="7" v-else-if="isSignIn===1"><router-link :class="[activeIndex==7?'meBtnOn':'meBtnOff']" to="/admin/artList">{{nickName}}</router-link></el-menu-item>
...
<!--                  <li><router-link to="/collections">Collections</router-link></li>-->
                  ...
                  <li v-if="isSignIn===0"><router-link  to="/sign">Sign In</router-link></li>
                  <li v-if="isSignIn===1||isSignIn===2"><router-link  to="/visiter">{{nickName}}</router-link></li>
                </ul>
              </div>
            </transition >
          </div>
