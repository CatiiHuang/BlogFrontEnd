    ...
    <div class="wrapper">
      <el-row>
        <el-col :xs="20" :sm="4" :md="4" :lg="4" :xl="4">
          <div class="logo">
            Catii ,
            <img class="logo-icon" src="/static/img/cat.png" alt="" />
          </div>
        </el-col>
        <el-col :xs="0" :sm="20" :md="20" :lg="20" :xl="20">
          ...
          >
            <el-menu-item index="1"
              ><router-link to="/"
                ><i class="iconfont icon-home"></i>Home</router-link
              ></el-menu-item
            >
            <el-menu-item index="2"
              ><router-link to="/archives"
                ><i class="iconfont icon-archives"></i>Archives</router-link
              ></el-menu-item
            >
            ...
            <el-menu-item index="5"
              ><router-link to="/demo"
                ><i class="iconfont icon-play"></i>Demo</router-link
              ></el-menu-item
            >
            <el-menu-item index="6"
              ><router-link to="/about"
                ><i class="iconfont icon-meho"></i>About</router-link
              ></el-menu-item
            >
            ...
            <transition name="slide-fade">
              <div v-if="navMobile" class="content">
                <ul @click="slideUp">
                  ...
                  <li v-if="isSignIn === 1 || isSignIn === 2">
                    <router-link to="/visiter">{{ nickName }}</router-link>
                  </li>
                </ul>
              </div>
            </transition>
